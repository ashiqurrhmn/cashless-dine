...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="relative z-20 flex items-center justify-between px-12 py-5 md:px-6 max-w-[90rem] mx-auto w-full">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 hidden max-md:flex justify-around items-center bg-[rgba(10,10,10,0.92)] backdrop-blur-xl border-t border-white/[0.08] pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2">
